...
public @interface UserMobileNumbersRelationConnectionSubscriptionArguments {
  ...
  UserMobileNumbersRelationOrderBy1 orderBy() default @UserMobileNumbersRelationOrderBy1;
  ...
  UserMobileNumbersRelationExpression1[] exs() default {};
