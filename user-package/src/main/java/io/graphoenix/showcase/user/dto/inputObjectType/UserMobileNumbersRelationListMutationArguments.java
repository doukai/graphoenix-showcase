...
public class UserMobileNumbersRelationListMutationArguments implements MetaInput {
  private String id;
  ...
  public Collection<UserMobileNumbersRelationInput> getList() {
    return this.list;
  }

  public void setList(Collection<UserMobileNumbersRelationInput> list) {
    this.list = list;
  }
