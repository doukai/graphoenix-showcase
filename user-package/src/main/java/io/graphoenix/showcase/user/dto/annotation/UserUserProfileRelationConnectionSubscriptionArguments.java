...
public @interface UserUserProfileRelationConnectionSubscriptionArguments {
  ...
  UserUserProfileRelationOrderBy1 orderBy() default @UserUserProfileRelationOrderBy1;
