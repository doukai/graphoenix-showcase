...
public class UserMobileNumbersRelationOrderBy {
  private Sort id;

  private Sort userRef;

  private Sort mobileNumbersRef;
  ...
  public Sort getMobileNumbersRef() {
    return this.mobileNumbersRef;
  }

  public void setMobileNumbersRef(Sort mobileNumbersRef) {
