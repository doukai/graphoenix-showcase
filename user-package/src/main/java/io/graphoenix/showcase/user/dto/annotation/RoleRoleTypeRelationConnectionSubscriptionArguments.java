...
public @interface RoleRoleTypeRelationConnectionSubscriptionArguments {
  ...
  RoleRoleTypeRelationOrderBy1 orderBy() default @RoleRoleTypeRelationOrderBy1;
  ...
  RoleRoleTypeRelationExpression1[] exs() default {};
