...
public class RoleUserRelationConnectionSubscriptionArguments implements MetaExpression {
  ...
  private RoleUserRelationOrderBy orderBy;
  ...
  public RoleUserRelationOrderBy getOrderBy() {
    return this.orderBy;
  }

  public void setOrderBy(RoleUserRelationOrderBy orderBy) {
  ...
  public Collection<RoleUserRelationExpression> getExs() {
    return this.exs;
  }

  public void setExs(Collection<RoleUserRelationExpression> exs) {
    this.exs = exs;
  }
