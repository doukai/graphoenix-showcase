...
public class UserUserProfileRelationConnectionSubscriptionArguments implements MetaExpression {
  ...
  private UserUserProfileRelationOrderBy orderBy;
  ...
  public void setUserProfileRef(StringExpression userProfileRef) {
  ...
  public UserUserProfileRelationOrderBy getOrderBy() {
    return this.orderBy;
  }

  public void setOrderBy(UserUserProfileRelationOrderBy orderBy) {
  ...
  public Collection<UserUserProfileRelationExpression> getExs() {
    return this.exs;
  }

  public void setExs(Collection<UserUserProfileRelationExpression> exs) {
    this.exs = exs;
  }
