...
public class RoleRoleTypeRelationConnectionSubscriptionArguments implements MetaExpression {
  ...
  private RoleRoleTypeRelationOrderBy orderBy;
  ...
  public void setRoleTypeRef(RoleTypeExpression roleTypeRef) {
  ...
  public RoleRoleTypeRelationOrderBy getOrderBy() {
    return this.orderBy;
  }

  public void setOrderBy(RoleRoleTypeRelationOrderBy orderBy) {
  ...
  public Collection<RoleRoleTypeRelationExpression> getExs() {
    return this.exs;
  }

  public void setExs(Collection<RoleRoleTypeRelationExpression> exs) {
    this.exs = exs;
  }
