...
public @interface GoodMerchantRelationConnectionSubscriptionArguments {
  ...
  GoodMerchantRelationOrderBy1 orderBy() default @GoodMerchantRelationOrderBy1;
  ...
  GoodMerchantRelationExpression1[] exs() default {};
