...
public @interface MerchantOrganizationRelationConnectionSubscriptionArguments {
  ...
  MerchantOrganizationRelationOrderBy1 orderBy() default @MerchantOrganizationRelationOrderBy1;
  ...
  MerchantOrganizationRelationExpression1[] exs() default {};
