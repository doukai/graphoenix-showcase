...
public class GoodOrderRelationConnectionSubscriptionArguments implements MetaExpression {
  ...
  private GoodOrderRelationOrderBy orderBy;
  ...
  public GoodOrderRelationOrderBy getOrderBy() {
    return this.orderBy;
  }

  public void setOrderBy(GoodOrderRelationOrderBy orderBy) {
  ...
  public Collection<GoodOrderRelationExpression> getExs() {
    return this.exs;
  }

  public void setExs(Collection<GoodOrderRelationExpression> exs) {
    this.exs = exs;
  }
