...
public class MerchantUserRelationConnectionSubscriptionArguments implements MetaExpression {
  ...
  private MerchantUserRelationOrderBy orderBy;
  ...
  public MerchantUserRelationOrderBy getOrderBy() {
    return this.orderBy;
  }

  public void setOrderBy(MerchantUserRelationOrderBy orderBy) {
  ...
  public Collection<MerchantUserRelationExpression> getExs() {
    return this.exs;
  }

  public void setExs(Collection<MerchantUserRelationExpression> exs) {
    this.exs = exs;
  }
