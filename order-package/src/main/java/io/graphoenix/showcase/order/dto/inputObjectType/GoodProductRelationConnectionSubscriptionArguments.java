...
public class GoodProductRelationConnectionSubscriptionArguments implements MetaExpression {
  ...
  private GoodProductRelationOrderBy orderBy;
  ...
  public GoodProductRelationOrderBy getOrderBy() {
    return this.orderBy;
  }

  public void setOrderBy(GoodProductRelationOrderBy orderBy) {
  ...
  public Collection<GoodProductRelationExpression> getExs() {
    return this.exs;
  }

  public void setExs(Collection<GoodProductRelationExpression> exs) {
    this.exs = exs;
  }
