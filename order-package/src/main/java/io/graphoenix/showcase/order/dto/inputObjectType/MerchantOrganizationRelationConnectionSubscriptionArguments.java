...
public class MerchantOrganizationRelationConnectionSubscriptionArguments implements MetaExpression {
  ...
  private MerchantOrganizationRelationOrderBy orderBy;
  ...
  public void setOrganizationRef(IntExpression organizationRef) {
  ...
  public MerchantOrganizationRelationOrderBy getOrderBy() {
    return this.orderBy;
  }

  public void setOrderBy(MerchantOrganizationRelationOrderBy orderBy) {
  ...
  public Collection<MerchantOrganizationRelationExpression> getExs() {
    return this.exs;
  }

  public void setExs(Collection<MerchantOrganizationRelationExpression> exs) {
    this.exs = exs;
  }
