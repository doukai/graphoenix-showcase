...
public @interface MerchantDirectorConnectionSubscriptionArguments {
  ...
  MerchantDirectorOrderBy1 orderBy() default @MerchantDirectorOrderBy1;
  ...
  MerchantDirectorExpression1[] exs() default {};
